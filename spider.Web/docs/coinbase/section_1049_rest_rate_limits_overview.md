...
Rate-limiting for Exchange REST API uses a **lazy-fill token bucket** implementation.
...
When a user sends a request, the TokenBucket calculates whether to rate limit the user as follows:
