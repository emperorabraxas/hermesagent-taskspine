...
Source: https://docs.cdp.coinbase.com/server-wallets/v2/introduction/quickstart
...
Sign in to the [CDP Portal](https://portal.cdp.coinbase.com), [create a CDP API key](https://portal.cdp.coinbase.com/projects/api-keys) and [generate a Wallet Secret](https://portal.cdp.coinbase.com/products/server-wallet/accounts).
...
<Tabs>
  <Tab title="Typescript">
    You can send transactions on Solana using the [`@solana/web3.js`](https://solana.com/docs/clients/official/javascript) v1 library.
  ...
  <Tab title="Python">
    You can send transactions on Solana using the [`solana`](https://solana.com/docs/clients/community/python) library.
