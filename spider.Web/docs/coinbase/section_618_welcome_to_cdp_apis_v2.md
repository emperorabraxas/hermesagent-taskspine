# Welcome to CDP APIs v2
Source: https://docs.cdp.coinbase.com/api-reference/v2/introduction

The Coinbase Developer Platform (CDP) APIs allow you to safely and securely connect to CDP's suite of backend services to easily build onchain apps.
...
To get started with our APIs, follow the [Authentication](/api-reference/v2/authentication) guide.
...
* [CDP APIs](/api-reference/introduction) - Learn more about building onchain apps
