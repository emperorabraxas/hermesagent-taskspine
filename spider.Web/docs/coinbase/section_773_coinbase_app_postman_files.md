# Coinbase App Postman Files
Source: https://docs.cdp.coinbase.com/coinbase-app/api-architecture/postman-files



The following Postman collection and environment files are available for download.

* <a href="/coinbase-app/api-architecture/files/coinbase_app.postman_collection.json">Coinbase Developer Platform Coinbase App Postman Collection</a>
* <a href="/coinbase-app/api-architecture/files/coinbase_developer_platform.postman_environment.json">Coinbase Developer Platform Postman Environment</a>
...
1. **Download Collection:**
   * Download the <a href="/coinbase-app/api-architecture/files/coinbase_app.postman_collection.json">Coinbase Developer Platform Coinbase App Postman Collection</a>
