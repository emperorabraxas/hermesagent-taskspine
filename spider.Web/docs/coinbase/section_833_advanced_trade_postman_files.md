...
Source: https://docs.cdp.coinbase.com/coinbase-business/advanced-trade-apis/postman-files



The following Postman collection and environment files are available for download.

* <a href={`/coinbase-business/advanced-trade-apis/files/coinbase_advanced_trading.postman_collection.json`}>Coinbase Developer Platform Advanced Trade Postman Collection</a>
* <a href={`/coinbase-business/advanced-trade-apis/files/coinbase_developer_platform.postman_environment.json`}>Coinbase Developer Platform Postman Environment</a>
...
1. **Download Collection:**
   * Download the <a href={`/coinbase-business/advanced-trade-apis/files/coinbase_advanced_trading.postman_collection.json`}>Coinbase Developer Platform Advanced Trade Postman Collection</a>
