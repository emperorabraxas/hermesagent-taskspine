# Coinbase Business Postman Files
Source: https://docs.cdp.coinbase.com/coinbase-business/api-architecture/postman-files



The following Postman collection and environment files are available for download.

* <a href="/coinbase-business/api-architecture/files/coinbase_app.postman_collection.json">Coinbase Developer Platform Coinbase Business Postman Collection</a>
...
1. **Download Collection:**
   * Download the <a href="/coinbase-business/api-architecture/files/coinbase_app.postman_collection.json">Coinbase Developer Platform Coinbase Business Postman Collection</a>
