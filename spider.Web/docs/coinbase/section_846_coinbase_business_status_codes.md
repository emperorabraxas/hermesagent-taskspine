# Coinbase Business Status Codes
Source: https://docs.cdp.coinbase.com/coinbase-business/api-architecture/status-codes



Coinbase Business supports the following status codes:
