# Coinbase Business OAuth2 Integration
Source: https://docs.cdp.coinbase.com/coinbase-business/authentication-authorization/oauth2/integrations



## Registering OAuth2 Client

Before integrating Coinbase Business, you need to register a new OAuth2 application under your [CDP API settings](https://portal.cdp.coinbase.com/access/oauth). If you're using a previous OAuth2 implementation, you may need to configure the following settings:
...
Coinbase recommends integrating your OAuth client with a battle-tested OAuth2 library so that you can simply plug in your client id, client secret, etc. Consider using one of the following [OAuth2 libraries](https://oauth.net/code/).
...
| `state`         | **Optional** An unguessable random string to protect against cross-site request forgery attacks. Must be at least 8 characters long. [Read more](/coinbase-app/authentication-authorization/oauth2/security-best-practices) |
...
You can further customize the authorization page and permissions. Read more at [OAuth2 reference](/coinbase-app/authentication-authorization/oauth2/reference).
