# Coinbase Business OAuth2 Reference
Source: https://docs.cdp.coinbase.com/coinbase-business/authentication-authorization/oauth2/reference
...
| `state` *Optional*        | An unguessable random string to protect against cross-site request forgery attacks. Must be at least 8 characters long. [Read more about security](/coinbase-app/authentication-authorization/oauth2/security-best-practices) |

Coinbase Business supports many platform specific parameters (in addition to common OAuth2 parameters) which can be used to customize the user experience.
