# Send Crypto
Source: https://docs.cdp.coinbase.com/coinbase-business/transfer-apis/send-crypto
...
When used with OAuth2 authentication, this endpoint requires [two factor authentication](/coinbase-app/authentication-authorization/oauth2/2fa).
...
| `travel_rule_data`      | object  | Optional | Visit the [Guide](/coinbase-business/transfer-apis/travel-rule) for more details                      |
