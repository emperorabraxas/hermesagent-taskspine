"""Oracle agent — conversational chat, brainstorming, writing."""
...
class OracleAgent(BaseAgent):
    def __init__(self):
        ...
        agent_cfg = config["agents"]["oracle"]
        settings = get_settings()
        self._model = settings.oracle_model or agent_cfg["local_model"]
        ...
        self._info = AgentInfo(
            ...
            xp_base=agent_cfg.get("xp_base", 5),
        )
