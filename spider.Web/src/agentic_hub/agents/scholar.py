"""Scholar agent — research, analysis, summarization."""
...
class ScholarAgent(BaseAgent):
    def __init__(self):
        ...
        agent_cfg = config["agents"]["scholar"]
        settings = get_settings()
        self._model = settings.scholar_model or agent_cfg["local_model"]
        ...
        self._info = AgentInfo(
            ...
            xp_base=agent_cfg.get("xp_base", 10),
        )
